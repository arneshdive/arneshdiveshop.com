      ...
      <nav className="flex items-center justify-between px-6 lg:px-12 py-4 max-w-[1440px] mx-auto w-full">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="hidden lg:flex gap-6">
            <Link href="/freediving" className={`text-base tracking-wide transition-colors ${linkColor}`}>
              Freediving
            </Link>
            <Link href="/scuba" className={`text-base tracking-wide transition-colors ${linkColor}`}>
              Scuba
            </Link>
            <Link href="/aksesoris" className={`text-base tracking-wide transition-colors ${linkColor}`}>
              Aksesoris
            </Link>
            <Link href="/sale" className={`text-base tracking-wide font-medium transition-colors ${saleColor}`}>
              Sale
            </Link>
          </div>
        </div>
